...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            final ImageView thumbnailContainer = view.findViewById(R.id.thumbnail);
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Bundle b = ActivityOptionsCompat.makeSceneTransitionAnimation(ArticleListActivity.this, thumbnailContainer, thumbnailContainer.getTransitionName()).toBundle();
                    startActivity(new Intent(Intent.ACTION_VIEW,
                            ItemsContract.Items.buildItemUri(getItemId(vh.getAdapterPosition()))), b);
                }
            });
            return vh;
        }
